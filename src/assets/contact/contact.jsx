...
function Contact() {
    return (
        <>
            <div className='d-flex justify-content-center align-items-center flex-column shadow color1'>
                <div className='d-flex justify-content-center align-items-center'>
                    <div className='p-2 m-3 d-flex justify-content-center align-items-center flex-column'>
                        <h4>Contact No</h4>
                        <h4>+91 8489524045</h4>
                    </div>
                    <div className='p-2 m-3 d-flex justify-content-center align-items-center flex-column'>
                        <h4>Email</h4>
                        <h4>chakkaravarthik99@gmail.com</h4>
                    </div>
                </div>
                <div className="d-flex justify-content-start ">
                    <a className='p-3' href='https://www.linkedin.com/in/chakkaravarthi-k-083345172/' target="_blank"><svg fill="#ffffff" width="50px" height="50px" viewBox="0 0 256 256" id="Flat" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a className='p-3' href='https://github.com/Chakkaravarthik' target='_blank'>
                        <svg fill="#ffffff" width="50px" height="50px" viewBox="0 0 32 32" id="icon" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a className='p-3' href='https://drive.google.com/file/d/1MJ-l56pMsoa0v37OU4HoXRFsMDReb1o8/view?usp=drive_link' target='_blank'>
                        <svg height="50px" width="50px" version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                            ...
                            <g>
                                <path fill='#ffffff' d="M276.239,252.183c-6.37,2.127-13.165,3.308-20.239,3.308c-7.074,0-13.87-1.181-20.24-3.308
		c-46.272,7.599-70.489,41.608-70.489,82.877H256h90.728C346.728,293.791,322.515,259.782,276.239,252.183z"/>
                                <path fill='#ffffff' d="M256,240.788c27.43,0,49.658-22.24,49.658-49.666v-14.087c0-27.426-22.228-49.659-49.658-49.659
		c-27.43,0-49.658,22.233-49.658,49.659v14.087C206.342,218.548,228.57,240.788,256,240.788z"/>
                                <path fill='#ffffff' d="M378.4,0H133.582C86.234,0,47.7,38.542,47.7,85.899v340.22C47.7,473.476,86.234,512,133.582,512h205.695
